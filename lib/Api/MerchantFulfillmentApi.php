...
use ClouSale\AmazonSellingPartnerAPI\Models\MerchantFulfillment\CancelShipmentResponse;
use ClouSale\AmazonSellingPartnerAPI\Models\MerchantFulfillment\CreateShipmentResponse;
use ClouSale\AmazonSellingPartnerAPI\Models\MerchantFulfillment\GetShipmentResponse;
...
class MerchantFulfillmentApi
{
    ...
    public function getShipmentWithHttpInfo($shipment_id)
    {
        ...
        return $this->sendRequest($request, GetShipmentResponse::class);
    }
    ...
    public function getShipmentAsyncWithHttpInfo($shipment_id)
    {
        ...
        return $this->sendRequestAsync($request, GetShipmentResponse::class);
    }
