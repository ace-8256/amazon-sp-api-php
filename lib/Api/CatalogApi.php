...
class CatalogApi
{
	...
	public function getCatalogItem1($marketplace_id, $asin)
    {
        list($response) = $this->getCatalogItemWithHttpInfo1($marketplace_id, $asin);
	...
	public function getCatalogItemWithHttpInfo1($marketplace_id, $asin)
    {
        $request = $this->getCatalogItemRequest1($marketplace_id, $asin);
    ...
    protected function getCatalogItemRequest($marketplace_id, $asin)
    {
		...
		$queryParams['includedData'] = 'attributes,dimensions,identifiers,images,productTypes,relationships,salesRanks,summaries,classifications';
        return $this->generateRequest($multipart, $formParams, $queryParams, $resourcePath, $headerParams, 'GET', $httpBody);
    }
	    protected function getCatalogItemRequest1($marketplace_id, $asin)
    {
        // verify the required parameter 'marketplace_id' is set
        if (null === $marketplace_id || (is_array($marketplace_id) && 0 === count($marketplace_id))) {
            throw new InvalidArgumentException('Missing the required parameter $marketplace_id when calling getCatalogItem');
