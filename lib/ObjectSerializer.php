...
class ObjectSerializer
{
    ...
    public static function sanitizeForSerialization($data, $type = null, $format = null)
    {
        if (is_scalar($data) || null === $data) {
            ...
            if(!empty($data::swaggerTypes())){
                foreach ($data::swaggerTypes() as $property => $swaggerType) {
                    $getter = $data::getters()[$property];
                    $value = $data->$getter();
                    if (null !== $value  && !in_array($swaggerType, ['DateTime', 'bool', 'boolean', 'byte', 'double', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], true) && method_exists($swaggerType, 'getAllowableEnumValues') && !in_array($value, $swaggerType::getAllowableEnumValues())) {
                ...
                return $data->offsetGet($data->getModelName());
            }
        } else {
            return (string) $data;
        }
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (empty($data)) {
            ...
            if(!empty($instance::swaggerTypes())){
                ...
                $instance->offsetSet($instance->getModelName(),$data);
            }
            return $instance;
        }
    }
