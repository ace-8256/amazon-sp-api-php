...
'item_dimensions' => 'getItemDimensions',    ];
    ...
    {
        return $this->container['indentifiers'];
    }

    /**
     * Sets indentifiers.
     *
     * @param string $indentifiers the color variation of the item
     *
     * @return $this
     */
    public function setIdentifiers($indentifiers)
    {
        $this->container['indentifiers'] = $indentifiers;
